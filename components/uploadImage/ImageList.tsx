  ...
  return (
    <article className="flex flex-col md:flex-wrap md:flex-row gap-16 md:gap-24 flex-auto overflow-x-hidden">
      {list?.map((image: ImageObject,index) => (
        <div key={image.title} className="md:w-[calc(50%-12px)] lg:w-[calc(33.33%-16px)] min-h-416 xl:min-h-512 rounded-lg overflow-hidden relative bg-black hover:bg-none">
          <Image
